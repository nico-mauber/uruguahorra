...
//
// Proxy de voz → texto → transacción estructurada. NUNCA se llama a OpenAI desde
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (!openaiKey) return json({ error: 'IA no configurada' }, 500);
    ...
    // 1) Whisper: transcribir en español.
    ...
    // 2) gpt-4o-mini: parsear a transacción estructurada.
