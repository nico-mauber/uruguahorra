...
if (typeof window !== 'undefined') {
  const globalWindow = window as Window & {
    ...
    checkImportMetaErrors: () => boolean;
  };

  globalWindow.errorMonitor = errorMonitor;
  globalWindow.getErrorLogs = () => errorMonitor.getLogs();
  globalWindow.clearErrorLogs = () => errorMonitor.clearLogs();
  globalWindow.exportErrorLogs = () => errorMonitor.exportLogs();
  globalWindow.checkImportMetaErrors = () => errorMonitor.hasImportMetaErrors();
}
