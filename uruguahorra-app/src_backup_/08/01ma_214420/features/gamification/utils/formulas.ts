import { XP_RULES, QUEST_SETTINGS } from './constants';
...
/**
 * XP por completar quest semanal (fijo)
 */
export const calculateQuestXP = (): number => {
  return QUEST_SETTINGS.QUEST_XP_BONUS;
};
