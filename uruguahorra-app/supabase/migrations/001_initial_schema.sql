-- ============================================
-- URUGUAHORRA DATABASE SCHEMA
-- ============================================
-- Migración inicial para Supabase (PostgreSQL)
-- Incluye: tablas, RLS, políticas, índices y datos semilla
-- ============================================
...
-- RLS para challenges (tabla pública de solo lectura)
ALTER TABLE challenges ENABLE ROW LEVEL SECURITY;

-- Política para challenges (todos pueden leer)
...
-- RLS para learnings (tabla pública de solo lectura)
ALTER TABLE learnings ENABLE ROW LEVEL SECURITY;

-- Política para learnings (todos pueden leer)
...
-- Políticas para audit_logs (solo los propios logs)
...
CREATE INDEX idx_micro_contributions_user_id ON micro_contributions(user_id);
CREATE INDEX idx_micro_contributions_goal_id ON micro_contributions(goal_id);
CREATE INDEX idx_micro_contributions_created_at ON micro_contributions(created_at DESC);
CREATE INDEX idx_micro_contributions_source ON micro_contributions(source);
CREATE INDEX idx_micro_contributions_user_goal ON micro_contributions(user_id, goal_id);
...
CREATE INDEX idx_user_challenges_completed_at ON user_challenges(completed_at DESC) WHERE completed_at IS NOT NULL;
...
CREATE INDEX idx_squad_members_joined_at ON squad_members(joined_at DESC);

-- Índices para transactions_raw
CREATE INDEX idx_transactions_raw_user_id ON transactions_raw(user_id);
CREATE INDEX idx_transactions_raw_ts ON transactions_raw(ts DESC);
CREATE INDEX idx_transactions_raw_category ON transactions_raw(category);
CREATE INDEX idx_transactions_raw_user_ts ON transactions_raw(user_id, ts DESC);

-- Índices para learnings
CREATE INDEX idx_learnings_active ON learnings(is_active) WHERE is_active = TRUE;
CREATE INDEX idx_learnings_category ON learnings(category);
CREATE INDEX idx_learnings_difficulty ON learnings(difficulty);

-- Índices para user_progress
CREATE INDEX idx_user_progress_user_id ON user_progress(user_id);
CREATE INDEX idx_user_progress_learning_id ON user_progress(learning_id);
...
CREATE INDEX idx_paywall_events_user_id ON paywall_events(user_id);
CREATE INDEX idx_paywall_events_event ON paywall_events(event);
CREATE INDEX idx_paywall_events_ts ON paywall_events(ts DESC);
